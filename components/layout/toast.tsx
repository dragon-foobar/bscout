  ...
  return bannerHidden ? null : (
    ...
    >
      <div className="rounded-[14px] w-full h-full bg-[#111111] flex flex-col sm:flex-row items-center justify-center sm:justify-between space-y-3 sm:space-y-0 px-5">
        <p className="text-white text-[13px]  w-[304px] h-[40px] flex items-center justify-center p-3">
        ...
        <a
          className="text-white text-[13px]  bg-black border border-[#333333] hover:border-white transition-all rounded-md w-[220px] h-[40px] flex items-center justify-center whitespace-nowrap"
